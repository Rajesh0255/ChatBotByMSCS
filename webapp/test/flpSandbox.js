		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat Bot",
									"targetURL": "#comappchatbot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappchatbot-display": {
								"semanticObject": "comappchatbot",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.chatbot",
									"url": sap.ui.require.toUrl("com/app/chatbot")
								}
							}
						}
					}
